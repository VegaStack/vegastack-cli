...
| `src/commands/`              | `init`, `ask`, `search`, `registry`, `doctor`, `skills`, `scan`, `preview`, `update`. |
...
- Keep public command names predictable: `ask`, `search`, `init`, `registry update`, `scan`, `doctor`.
