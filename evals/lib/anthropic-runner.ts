...
//                  whatever's already on the runner's PATH (no `vegastack ask --pack terraform --tf-provider <provider>`).
//   - with-skill : the harness pre-loads the SKILL.md body into the system
//                  prompt and exposes `vegastack ask --pack terraform --tf-provider <provider> "<query>"` as the prescribed
