...
1. Run `vegastack generate <intent> --json`; the CLI caches fresh detection and includes fresh detection in the contract.
...
If the user only asks for a generated contract or includes `--json`, stop after returning/summarizing the contract. Do not write files unless the user asks you to create or update them.
