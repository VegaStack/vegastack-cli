...
export function vegastackConfigRoot(): string {
  ...
  return path.join(HOME, ".config", "vegastack");
}
...
/** Project-local agent instructions generated by `vegastack init`. */
export function projectInstructionsDir(cwd: string): string {
  return path.join(projectVegaStackDir(cwd), "instructions");
}
...
/** Project-local VegaStack state directory. Kept small and intended to be gitignored. */
...
export function projectManifestPath(cwd: string): string {
  return path.join(projectVegaStackDir(cwd), "project.json");
}

export function projectLockPath(cwd: string): string {
  return path.join(projectVegaStackDir(cwd), "vegastack-lock.json");
}
