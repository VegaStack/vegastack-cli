...
export const terraformDiscoverSchema = {
  query: z
    .string()
...
export const terraformDiscoverDescription =
  "Primary VegaStack discovery tool. Searches the Registry-provided Terraform-provider docs and " +
...
export type TerraformDiscoverArgs = {
  query: string;
  provider?: string;
  max?: number;
};

export async function handleTerraformDiscover(env: Env, args: TerraformDiscoverArgs) {
