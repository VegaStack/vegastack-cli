...
- **Pin the npm version** (for example, `npm i -g @vegastack/cli@0.1.12-next.0` during prerelease testing) and consider `npm ci --ignore-scripts` to skip package lifecycle scripts; then run `vegastack init` inside each project under your own audit.
